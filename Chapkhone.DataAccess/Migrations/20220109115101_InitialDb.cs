        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<double>(type: "float", maxLength: 350, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "float", nullable: false),
                    OrderTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OrderQty = table.Column<int>(type: "int", nullable: false),
                    OrderDescription = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: true),
                    DesignGroupId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationOrderTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationOrderTypes_DesignGroups_DesignGroupId",
                        column: x => x.DesignGroupId,
                        principalTable: "DesignGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SpecificationOrderTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationOrderGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationOrderGroups_SpecificationOrderTypes_SpecificationOrderTypeId",
                        column: x => x.SpecificationOrderTypeId,
                        principalTable: "SpecificationOrderTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecificationOrderImages_SpecificationOrderTypes_SpecificationOrderTypeId",
                        column: x => x.SpecificationOrderTypeId,
                        principalTable: "SpecificationOrderTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationOrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationOrderItems_SpecificationOrderGroups_SpecificationOrderGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecificationOrderItemId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationOrderValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationOrderValues_SpecificationOrderItems_SpecificationOrderItemId",
                        column: x => x.SpecificationOrderItemId,
                        principalTable: "SpecificationOrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecificationOrderGroups_SpecificationOrderTypeId",
                table: "SpecificationOrderGroups",
                column: "SpecificationOrderTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecificationOrderImages_SpecificationOrderTypeId",
                table: "SpecificationOrderImages",
                column: "SpecificationOrderTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecificationOrderItems_SpecificationOrderGroupId",
                table: "SpecificationOrderItems",
                column: "SpecificationOrderGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecificationOrderTypes_DesignGroupId",
                table: "SpecificationOrderTypes",
                column: "DesignGroupId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SpecificationOrderValues_SpecificationOrderItemId",
                table: "SpecificationOrderValues",
                column: "SpecificationOrderItemId",
                unique: true);
        }
